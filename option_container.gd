...
@onready var option_container = get_node(".")
@onready var general_h_scroll_bar = get_node("%General_HScrollBar")
@onready var music_h_scroll_bar = get_node("%Music_HScrollBar")
@onready var sfx_h_scroll_bar = get_node("%SFX_HScrollBar")
...
func _load_settings():
	if settings_file.load("res://settings.cfg") != OK:
		...
		general_h_scroll_bar.value = audio.x
		music_h_scroll_bar.value = audio.y
		sfx_h_scroll_bar.value = audio.z
